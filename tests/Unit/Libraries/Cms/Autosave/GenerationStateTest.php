...
class GenerationStateTest extends UnitTestCase
{
    ...
    public function transitionProvider(): array
    {
        return [
            ...
            'active to closed'       => [GenerationState::Active, GenerationState::Closed, true],
            'active to retired'      => [GenerationState::Active, GenerationState::Retired, false],
            ...
            'closed to active'       => [GenerationState::Closed, GenerationState::Active, false],
            'closed to closed'       => [GenerationState::Closed, GenerationState::Closed, false],
            'closed to retired'      => [GenerationState::Closed, GenerationState::Retired, true],
            'closed to discarded'    => [GenerationState::Closed, GenerationState::Discarded, false],
            'closed to expired'      => [GenerationState::Closed, GenerationState::Expired, false],
            'retired to active'      => [GenerationState::Retired, GenerationState::Active, false],
            'retired to closed'      => [GenerationState::Retired, GenerationState::Closed, false],
