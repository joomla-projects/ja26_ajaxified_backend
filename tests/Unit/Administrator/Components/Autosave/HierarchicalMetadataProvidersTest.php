...
class HierarchicalMetadataProvidersTest extends UnitTestCase
{
    public function testExactContextsIdentityAndPayloadContracts(): void
    {
        ...
        $this->assertSame(['title', 'note', 'description', 'version_note', 'metadesc', 'metakey', 'parent_id'], array_keys($providers[0]->normalizePayload([...$rich, 'parent_id' => 1], 2)));
        ...
        $this->assertFailure('invalid_payload', fn () => $providers[0]->normalizePayload([...$rich, 'parent_id' => '2'], 2));
        $this->assertFailure('invalid_payload', fn () => $providers[0]->normalizePayload([...$rich, 'parent_id' => 0], 2));
