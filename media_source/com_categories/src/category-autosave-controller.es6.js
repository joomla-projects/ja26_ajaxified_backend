...
export default class CategoryAutosaveController extends AutosaveIntegrationController {
  constructor({ documentSource = globalThis.document, optionsReader = defaultOptionsReader, editorRegistry = JoomlaEditor, adapterFactory = (options) => new CategoryAutosaveAdapter(options), ...options } = {}) {
    const resolve = () => {
