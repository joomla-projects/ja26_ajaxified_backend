...
<div id="j-main-container" class="j-main-container">
    <form action="<?php echo Route::_('index.php?option=com_finder&view=searches'); ?>" method="post" name="adminForm" id="adminForm">
        <div class="row">
            <div class="col-md-12">
                <?php
                echo LayoutHelper::render('joomla.searchtools.default', ['view' => $this, 'options' => ['filterButton' => false]]);
                echo LayoutHelper::render('joomla.system.toggle-columns', ['table-selector' => '#finderSearchList']);
                ?>
                ...
                <?php else : ?>
                <table class="table" id="finderSearchList">
